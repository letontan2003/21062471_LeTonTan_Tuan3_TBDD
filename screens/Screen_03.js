...
export default function App({navigation}) {
    const [data, setData] = useState([
        ...
        {key: '1', type: 'Vegetable', name: 'Pear', price: '28.00', image: require('../assets/Image 102 (1).png'), sl: 2},
        {key: '1', type: 'Vegetable', name: 'Coconut', price: '28.00', image: require('../assets/Image 103.png'), sl: 3},
        {key: '1', type: 'Vegetable', name: 'Pear', price: '28.00', image: require('../assets/Image 105.png'), sl: 1},
        {key: '1', type: 'Vegetable', name: 'Coconut', price: '28.00', image: require('../assets/Image 106 (1).png'), sl: 2},
        {key: '1', type: 'Vegetable', name: 'Coconut', price: '28.00', image: require('../assets/Image 107.png'), sl: 3},
        {key: '1', type: 'Vegetable', name: 'Pear', price: '28.00', image: require('../assets/Image 105.png'), sl: 1},
